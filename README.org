...
Integration with Flycheck is enabled by default, if Flycheck is installed. The integration customises Flycheck's =flycheck-executale-find= function to search for binaries in an activate Pipenv virtual environment.
